...
func continents(continent: String, countryCount: Int) {
    print("\(continent) is a continent which contains \(countryCount) countries")
}

continents(continent: "North America", countryCount: 3)
...
func bottles(numberOfBottles: Int, beverage: String, location: String) {
    print("\(numberOfBottles) bottles of \(beverage) on the \(location) wall.")
}

bottles(numberOfBottles: 10, beverage: "soda", location: "back")
